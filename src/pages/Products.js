  ...
  return (
    <div className=" bg-slate-100">
      <div className="flex flex-col items-center">
        <h1 className="text-3xl font-extrabold mt-10">Products</h1>
      </div>
      <div className="grid w-full h-screen md:flex flex-row items-center justify-evenly">
        <div className="flex flex-col items-center">
          ...
          <p className="font-medium text-base mt-2">$79</p>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-56 h-72 rounded-xl bg-[white] drop-shadow-2xl skew-y-3 origin-bottom-left flex justify-center items-center">
            <img src={ccs} />
          ...
          <p className="font-medium text-base mt-2">$239</p>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-56 h-72 rounded-xl bg-[white] drop-shadow-2xl skew-y-3 origin-bottom-left flex justify-center items-center">
            <img src={tester} />
          ...
          <p className="font-medium text-base mt-2">$789</p>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-56 h-72 rounded-xl bg-[white] drop-shadow-2xl skew-y-3 origin-bottom-left flex justify-center items-center">
            <img src={cable} />
          ...
          <p className="font-medium text-base mt-2">$39</p>
        </div>
      </div>
    </div>
  );
